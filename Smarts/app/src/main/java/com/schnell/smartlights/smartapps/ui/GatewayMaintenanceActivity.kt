...
class GatewayMaintenanceActivity : Activity() {
...
//        webView!!.settings.javaScriptEnabled = true
        ...
        //local server
//        webView!!.loadUrl("http://schnelliot.in/dashboardGroups/ab56d7b0-ef66-11eb-8a35-d3944034ebfd/3b659180-fbfa-11eb-85f1-8dafaa1d1e28", map)
        //live server
        webView!!.loadUrl("http://schnelliot.in/dashboardGroups/ab56d7b0-ef66-11eb-8a35-d3944034ebfd/3b659180-fbfa-11eb-85f1-8dafaa1d1e28", map)
    }
